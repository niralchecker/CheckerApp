...
public class FindUserLocationActivity extends AppCompatActivity {
    ...
    private void getAddress() {
        if (!Geocoder.isPresent()) {
            Toast.makeText(FindUserLocationActivity.this, "Can't find current address, ",
    ...
    private class LocationAddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == 1) {
                Toast.makeText(FindUserLocationActivity.this, "Address not found, ", Toast.LENGTH_SHORT).show();
            }
